...
try:
    fphet.createVariable('RAINNC24','f4',('time','sn', 'we'))
except Exception:
    pass
fphet['RAINNC24'][:]=prcp_het[:]
...
try:
    ...
    pass
try:
    fphmg.createVariable('RAINNC24','f4',('time','sn', 'we'))
except Exception:
    pass
fphmg['RAINNC24'][:]=prcp_hmg[:]
