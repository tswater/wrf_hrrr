...
het_tkelo=float('nan')*np.ones((N,snscl,wescl))
hmg_tkelo=float('nan')*np.ones((N,snscl,wescl))
het_tke=float('nan')*np.ones((N,snscl,wescl))
hmg_tke=float('nan')*np.ones((N,snscl,wescl))
cape2d_het=float('nan')*np.ones((N,2,sn,we))
clouds_het=float('nan')*np.ones((N,3,sn,we))

cape2d_hmg=float('nan')*np.ones((N,2,sn,we))
clouds_hmg=float('nan')*np.ones((N,3,sn,we))


het_hfx=float('nan')*np.ones((N,sn,we))
hmg_hfx=float('nan')*np.ones((N,sn,we))
hfx60=float('nan')*np.ones((N,snscl,wescl))
het_hfxv=float('nan')*np.ones((N,snscl,wescl))

het_lh=float('nan')*np.ones((N,sn,we))
hmg_lh=float('nan')*np.ones((N,sn,we))
lh60=float('nan')*np.ones((N,snscl,wescl))
het_lhv=float('nan')*np.ones((N,snscl,wescl))

het_r=float('nan')*np.ones((N,sn,we))
hmg_r=float('nan')*np.ones((N,sn,we))
het_lwp=float('nan')*np.ones((N,sn,we))
hmg_lwp=float('nan')*np.ones((N,sn,we))



time=float('nan')*np.ones((N,))
