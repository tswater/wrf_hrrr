# Aggregate variables listed by taking the mean, median, or sum
# over the last 24 hours in the 2 day simulation using conv files
# smvars have assumed size of t,snscl,wescl (are at 60km scale)
# bgvars have assumed size of t,sn,we
# medvars will have medians computed 
...
bigvars=['GFX_het','GFX_hmg','LWN_hmg','LWN_het','SWN_hmg','SWN_het','GLW_hmg','GLW_het']
smvars=[]
medvars=[]
